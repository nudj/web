...
export default (props) => {
  ...
  return (
    <div className={style.container}>
      ...
      <a className={style.link} href={relativeLink}>{`https://nudj.co${relativeLink}`}</a>
      <ul className={style.actions}>
        ...
        <li className={style.socialAction}>
          <a className={style.fbmLink} href=''>
            <svg width='24' height='24' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
              <path d='M12 0C5.373 0 0 4.975 0 11.11c0 3.498 1.745 6.617 4.472 8.653V24l4.086-2.242c1.09.3 2.246.464 3.442.464 6.627 0 12-4.974 12-11.11C24 4.974 18.627 0 12 0zm1.193 14.963l-3.056-3.26-5.963 3.26L10.734 8l3.13 3.26L19.75 8l-6.56 6.963z' fill='#007FFF' fill-rule='evenodd' />
            </svg>
