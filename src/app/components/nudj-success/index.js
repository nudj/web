  ...
  return (
    <div className={mobileOnly ? style.containerMobileOnly : style.container}>
      ...
      <div className={style.actions}>
        <a href={`fb-messenger://share/?link=${encodeURIComponent(link)}&app_id=${encodeURIComponent(process.env.FACEBOOK_APP_ID)}`} className={style.actionLink}>
        ...
        <a href={`whatsapp://send?text=${encodeURIComponent(link.replace(/\+/g, '%2B'))}`} className={style.actionLink}>
        ...
        <CopyToClipboard component='a' id='copy' className={style.actionLink} data-clipboard-text={link}>
